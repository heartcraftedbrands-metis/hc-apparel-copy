...
const [statusFunction, webhook, checkout, verify, adminSettings, config] = await Promise.all([
...
assert.match(checkout, /SUPABASE_SECRET_KEYS/);
...
console.log('Stripe test-mode connection checks passed (27 assertions).');
