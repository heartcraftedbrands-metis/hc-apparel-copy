  ...
  return <div className="min-h-screen bg-muted/30">
    ...
    <main className="container mx-auto max-w-6xl space-y-10 px-4 py-8">
      ...
      <section><h2 className="mb-4 text-sm font-bold uppercase tracking-wider text-muted-foreground">Business Settings</h2><div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
        <ToolLink to="/AdminPaymentSettings" label="Payment Settings" icon={<DollarSign />} /><ToolLink to="/AdminPaymentFeeSettings" label="Pricing & Shipping" icon={<Truck />} /><ToolLink to="/AdminSSApiSettings" label="S&S Vendor Settings" icon={<Settings />} /><ToolLink to="/AdminBrandPages" label="Brand Pages" icon={<Store />} /><ToolLink to="/AdminSubscribers" label="Subscribers" icon={<Mail />} /><ToolLink to="/AdminMessageTemplates" label="Message Templates" icon={<FileText />} /><ToolLink to="/AdminCustomerNotifications" label="Customer Notifications" icon={<Mail />} />
