          ...
          : action === 'get_american_apparel_fall_winter_candidate_report'
            ...
            : action === 'import_american_apparel_fall_winter_drafts'
              ...
              : action === 'get_next_level_candidate_report'
                ? `${data.winter_candidates} Next Level products reviewed; ${data.ready_for_private_import} pass current image, inventory, SKU, price, and HC Apparel margin checks.`
              ...
              : action === 'get_adidas_candidate_report'
                ? `${data.winter_candidates} Adidas products reviewed; ${data.ready_for_private_import} pass current image, inventory, SKU, price, and HC Apparel margin checks.`
              : action === 'audit_adidas_pricing'
                ? `${data.products_audited} live Adidas products audited against current S&S cost, HC Apparel pricing rules, margins, and payment floors. MAP and MSRP are reference only; no prices changed.`
              : action === 'reprice_adidas_without_map'
                ? `${data.products_audited} live Adidas products repriced from current S&S cost and HC Apparel protections. MAP and MSRP were not used.`
