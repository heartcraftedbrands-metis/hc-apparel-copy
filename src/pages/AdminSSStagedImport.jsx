  ...
  return (
    <div className="min-h-screen bg-muted/30 flex items-center justify-center p-8">
      <div className="max-w-md text-center space-y-4">
        ...
        <h1 className="text-xl font-bold text-muted-foreground">Staged Import — Archived</h1>
        <p className="text-sm text-muted-foreground">The old staged import system is no longer active.</p>
